...
public class PanelEliminarLocucion extends JPanel {
	...
	private static final String BUSCARCANCION = "buscarLocucion";
	private static final String ELIMINARCANCION = "eliminarLocucion";

	Color rosita = new Color(246, 212, 210, 255);
	Color morado = new Color(73, 39, 74, 255);
	Color lila = new Color(148, 97, 142, 255);

	public PanelEliminarLocucion() {
		...
		nombreCancion.setText("Digite el nombre de la locución");
