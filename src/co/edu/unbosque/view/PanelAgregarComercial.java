...
public class PanelAgregarComercial extends JPanel{
    ...
    private static final String GUARDARCANCION = "GuardarComercial";
    private static final String ELEGIRCANCION = "ElegirComercial";

    Color rosita = new Color(246,212,210,255);
	 Color morado = new Color(73,39,74,255);
	 Color lila = new Color(148,97,142,255);
	 
    public  PanelAgregarComercial() {
        ...
        panelSuperior.setPreferredSize(new Dimension(400, 200)); // Altura del panel superior
        panelSuperior.setLayout(null);

        // Panel inferior
        JPanel panelInferior = new JPanel();
        panelInferior.setBackground(morado);
        panelInferior.setPreferredSize(new Dimension(400, 300)); // Altura del panel inferior
      ...
      //para la barra
        ...
        genero.addItem("ALIMENTOS");
        genero.addItem("MUSICA");
        genero.addItem("ASEO");
        genero.addItem("HIGIENEPERSONAL");
        genero.addItem("PRODUCTOFINACIEROS");
        ...
        elegirCancion = new JButton("Elegir comercial");
