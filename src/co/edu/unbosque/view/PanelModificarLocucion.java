...
public class PanelModificarLocucion extends JPanel {
	...
	private static final String BUSCARCANCION = "buscarCancionML";
   private static final String MOFDIFICAR = "modificarCancionL";
   private static final String SELECCIONAR = "seleccionarL";
   
   Color rosita = new Color(246,212,210,255);
	 Color morado = new Color(73,39,74,255);
	 Color lila = new Color(148,97,142,255);
	 
	public PanelModificarLocucion() {
      ...
      //para la barra
        ...
        nuevoNombre.setText("Digite el nuevo nombre ");
      ...
      //para la barra
        ...
        nuevoGenero.addItem("HUMOR");
        nuevoGenero.addItem("HISTORIA");
        nuevoGenero.addItem("NOTICIA");
        nuevoGenero.addItem("CHISME");
