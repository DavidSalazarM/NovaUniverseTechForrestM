...
public class PanelOesteArriba extends JPanel {
	...
	public PanelOesteArriba() {
        ...
        //  panel 
        setBackground(lila);
        setBorder(BorderFactory.createLineBorder(lila, 6));
        setPreferredSize(new Dimension(250, 10)); // 
        setLayout(null);

        // Nombre de cada columna y crear tabla 
        String[] nombresColumnas = {"#", "Nombre", "Empresa", "Tipo"};
        ...
        TitledBorder tituloNombre = BorderFactory.createTitledBorder("Biblioteca de Comercial");
	...
	public void setGestorTabla(DefaultTableModel gestorTabla) {
		this.gestorTablaDos = gestorTabla;
	}
