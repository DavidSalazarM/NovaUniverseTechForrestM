...
public class PanelModificarComercial extends JPanel{
	...
	private static final String BUSCARCANCION = "buscarCancionMC";
   private static final String MOFDIFICAR = "modificarCancionC";
   private static final String SELECCIONAR = "seleccionarC";
   ...
   Color rosita = new Color(246,212,210,255);
	...
	public PanelModificarComercial() {
        ...
        nombreCancion.setForeground(lila);
      ...
      //para la barra
        ...
        nuevoNombre.setText("");
        nuevoNombre.setForeground(lila);
        nuevoNombre.setBounds(80, 350, 250, 40);
      //para la barra
        nuevoNombre.setFont(fuente);
        nuevoNombre.setText(" Digite el nombre ");
        ...
        nuevoArtista.setForeground(lila);
        nuevoArtista.setBounds(80, 400, 250, 40);
      //para la barra
        nuevoArtista.setFont(fuente);
        nuevoArtista.setText(" Digite el nuevo nombre ");
        ...
        nuevoGenero.addItem("ALIMENTOS");
        nuevoGenero.addItem("MUSICA");
        nuevoGenero.addItem("ASEO");
        nuevoGenero.addItem("HIGIENEPERSONAL");
        nuevoGenero.addItem("PRODUCTOFINACIERO");
